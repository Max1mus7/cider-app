    ...
    fn run_batch_script(manual: Vec<Step>) -> Vec<String> {
        ...
        if cfg!(windows) {
            ...
            outputs.push("A batch script was unable to be processed on Linux and was taken care of accordingly.".to_string());
        }
    ...
    fn command_setup_windows(args: Vec<String>) -> Command {
        //pass command first?
        Command::new("cmd")
    }

    fn command_setup_unix(args: Vec<String>) {}
