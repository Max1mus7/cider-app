...
- This supports both relative and absolute paths, but there have been some issues with how CIder handles directories both in the case of this setting and the [output_directory](#output_directory) setting. These issues will be looked into and resolved in the future.
- Defaulted to ./src
